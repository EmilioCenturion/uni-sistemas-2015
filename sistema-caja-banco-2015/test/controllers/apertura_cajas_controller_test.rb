...
class AperturaCajasControllerTest < ActionController::TestCase
  ...
  test "should create apertura_caja" do
    assert_difference('AperturaCaja.count') do
      post :create, apertura_caja: { apertura: @apertura_caja.apertura, caja_id: @apertura_caja.caja_id, cierre: @apertura_caja.cierre, saldo_final_cheque: @apertura_caja.saldo_final_cheque, saldo_final_efectivo: @apertura_caja.saldo_final_efectivo, saldo_inicial_cheque: @apertura_caja.saldo_inicial_cheque, saldo_inicial_efectivo: @apertura_caja.saldo_inicial_efectivo, user_id: @apertura_caja.user_id }
    end
