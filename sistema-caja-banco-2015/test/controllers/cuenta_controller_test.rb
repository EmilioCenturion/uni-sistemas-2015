...
class CuentaControllerTest < ActionController::TestCase
  ...
  test "should create cuentum" do
    assert_difference('Cuentum.count') do
      post :create, cuentum: { banco_id: @cuentum.banco_id, nro_cuenta: @cuentum.nro_cuenta, saldo: @cuentum.saldo }
    end
  ...
  test "should update cuentum" do
    patch :update, id: @cuentum, cuentum: { banco_id: @cuentum.banco_id, nro_cuenta: @cuentum.nro_cuenta, saldo: @cuentum.saldo }
    assert_redirected_to cuentum_path(assigns(:cuentum))
  end
