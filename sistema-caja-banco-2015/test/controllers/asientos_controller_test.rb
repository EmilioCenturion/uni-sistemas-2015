...
class AsientosControllerTest < ActionController::TestCase
  ...
  test "should create asiento" do
    assert_difference('Asiento.count') do
      post :create, asiento: { fecha: @asiento.fecha, nro_asiento: @asiento.nro_asiento, periodo_fiscal_id: @asiento.periodo_fiscal_id }
    end
  ...
  test "should update asiento" do
    patch :update, id: @asiento, asiento: { fecha: @asiento.fecha, nro_asiento: @asiento.nro_asiento, periodo_fiscal_id: @asiento.periodo_fiscal_id }
    assert_redirected_to asiento_path(assigns(:asiento))
  end
