...
rails g scaffold asiento nro_asiento:integer fecha:date periodo_fiscal:references 

rails g scaffold asiento_detalle asiento:references cuenta_contable:references importe:decimal es_credito:boolean concepto